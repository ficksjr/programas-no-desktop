...
from Exercícios.desafiosfinais.desafio112 import moeda
from Exercícios.desafiosfinais.desafio112 import dado

pr = dado.leiadinheiro('Digite um preço: R$ ')

moeda.resumo(pr, 12, 15)
